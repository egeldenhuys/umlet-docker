...
exec docker run --name umlet-docker --rm -i --user="$(id -u):$(id -g)" --net=none -v $PWD:/data egeldenhuys/umlet-docker java -jar umlet.jar -action=convert -format=png -filename "$@"
